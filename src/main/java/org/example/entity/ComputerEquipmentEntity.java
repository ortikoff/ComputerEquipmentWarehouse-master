...
public class ComputerEquipmentEntity {
    private int id;
    ...
    public ComputerEquipmentEntity(int id, String equipmentName, String category, double equipmentPrice, int equipmentQuantity) {
        this.id = id;
